namespace Santase.AI.SantiagoPlayer.GameSimulation
{
    ...
    public class SimSantaseGame : ISantaseGame
    {
        private readonly IGameRules gameRules;

        private readonly ISimPlayer firstPlayer;

        private readonly ISimPlayer secondPlayer;

        private readonly ILogger logger;

        private PlayerPosition firstToPlay = PlayerPosition.NoOne;

        public SimSantaseGame(ISimPlayer firstPlayer, ISimPlayer secondPlayer)
            : this(firstPlayer, secondPlayer, GameRulesProvider.Santase, new NoLogger())
        {
        }

        public SimSantaseGame(ISimPlayer firstPlayer, ISimPlayer secondPlayer, IGameRules gameRules, ILogger logger)
        {
            this.RestartGame();
        ...
        {
            var round = new SimRound(this.firstPlayer, this.secondPlayer, this.gameRules, this.firstToPlay);
